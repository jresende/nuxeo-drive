...
class TestWatchers(UnitTestCase):
    ...
    def test_local_watchdog_delete_non_synced(self):
        ...
        assert not self.engine_1.get_dao().get_states_from_partial_local(path)
    ...
    def test_local_watchdog_delete_synced(self):
        ...
        for child in children:
            assert child.pair_state == 'parent_locally_deleted'
    ...
    def test_local_scan_encoding(self):
        ...
        assert remote.exists(u'/P\xf4le applicatif/e\u0302tre ou ne pas \xeatre.odt')
        ...
        self.engine_1.stop()
        assert remote.get_info(u'/Accentue\u0301.odt').name == u'Accentu\xe9 avec un \xea et un \xe9.odt'
        assert remote.get_info(u'/P\xf4le applicatif').name == u'P\xf4le appliqu\xe9'
        assert remote.get_info(u'/P\xf4le applicatif/e\u0302tre ou ne pas \xeatre.odt').name == u'avoir et \xeatre.odt'
        ...
        assert remote.get_content(u'/P\xf4le applicatif/e\u0302tre ou ne pas \xeatre.odt') == u'Updated content'
        ...
        assert not remote.exists(u'/P\xf4le applicatif/e\u0302tre ou ne pas \xeatre.odt')
    ...
    def test_watchdog_encoding(self):
        ...
        self.wait_sync()
        assert not remote.exists(u'/Accentue\u0301.odt')
        assert not remote.exists(u'/Sub folder/e\u0302tre ou ne pas \xeatre.odt')
    ...
    def test_watcher_remote_id_setter(self):
        ...
        copyfile(self.location + '/resources/testFile.pdf', file_path)
        self.wait_sync()
        assert local.get_remote_id('/Test.pdf') == remote_id
